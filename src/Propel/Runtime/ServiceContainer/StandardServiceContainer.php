    ...
    protected function buildLogger($name = 'defaultLogger')
    {
        ...
        switch ($configuration['type']) {
            ...
            case 'syslog':
                ...
                break;
            default:
                throw new RuntimeException(sprintf('Handler type "%s" not supported by StandardServiceContainer. Try setting the Logger manually, or use another ServiceContainer.', $configuration['type']));
                break;
        }
